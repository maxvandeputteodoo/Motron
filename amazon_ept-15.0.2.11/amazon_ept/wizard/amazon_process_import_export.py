...
class AmazonProcessImportExport(models.TransientModel):
    ...
    def prepare_embed_code(operation):
        ...
        if operation and video_url_dict.get(operation):
            embed_code = f'<iframe width="100%" height="232px" ' \
    ...
    def amz_mapped_imports_products_ept(self, line, instance_dict, map_product_count, log_rec):
        ...
        :param : log_rec : common.log.book() object
        ...
        model_id = common_log_line_obj.get_model_id(PRODUCT_PRODUCT)
        amz_product_model_id = common_log_line_obj.get_model_id(AMZ_PRODUCT_EPT)
    ...
    def amz_read_import_file_with_product_list(self, line, row_number, log_rec):
        ...
        if not line.get(AMZ_SELLER_SKU):
            ...
            common_log_line_obj.amazon_create_product_log_line(message, model_id, False, seller_sku,
