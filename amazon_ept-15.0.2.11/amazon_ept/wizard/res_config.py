...
class AmazonConfigSettings(models.TransientModel):
    ...
    analytic_account_id = fields.Many2one('account.analytic.account', string='Analytic Account (Amazon)', help='Analytic Account')
    analytic_account_tag_ids = fields.Many2many('account.analytic.tag', string='Analytic Tags (Amazon)', help='Analytic Tags')
    ...
    def open_operations_tutorial(self):
        ...
        url = f'<iframe width="100%" height="420px" ' \
