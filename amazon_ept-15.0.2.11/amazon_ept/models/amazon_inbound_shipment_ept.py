...
class InboundShipmentEpt(models.Model):
    ...
    def amz_prepare_partnered_small_parcel_data(self, shipment, data, model_id, job):
        ...
        for package in shipment.partnered_small_parcel_ids:
            ...
            package_list.append({'Dimensions': {'Unit': dimension_unit, 'Length': str(package.ul_id.length),
                                 ...
                                 'Weight': {'Unit': package.weight_unit, 'Value': str(int(package.weight_value))}})
        if package_list:
    ...
    def export_non_partnered_small_parcel_tracking(self):
        ...
        for shipment in self:
            ...
            tracking_list, tacking_no_list = self.prepare_non_partnered_small_parcel_data(pickings, shipment, job,
                                                                                         model_id)
    ...
    def update_shipment_in_amazon(self, picking, sku_qty_list, instance, fba_shipment, job, auto_called):
        """
