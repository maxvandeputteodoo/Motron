...
class ResUsers(models.Model):
    ...
    def create(self, vals):
        ...
        if user.has_group('analytic.group_analytic_accounting') or user.has_group('analytic.group_analytic_tags'):
            amazon_seller_obj.create_analytic_account_and_tag_records()
        return user
